...
/**
 * v2 Shared member form used by Add and Edit modals.
 * Uses token-only styling with modern design patterns.
 */
const MemberForm: React.FC<MemberFormProps> = ({ 
  ...
  const availableMembers = useMemo(() => 
    existingMembers.filter((m: FamilyMember) => m.id !== currentMember?.id), 
    [existingMembers, currentMember?.id]
  );
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-6 text-(--color-neutral-900)">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) ${
                formErrors.name ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
              }`}
          ...
          <div>
            ...
            <select 
              ...
              onChange={handleInputChange} 
              aria-invalid={!!formErrors.relationship} 
              aria-describedby={formErrors.relationship ? getErrorId('relationship') : undefined} 
              className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) ${
                formErrors.relationship ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
              }`} 
              disabled={isSubmitting}
            >
            ...
            <div className="mt-1 min-h-[20px]" aria-live="polite">
              {formErrors.relationship && (
                <p id={getErrorId('relationship')} role="alert" className="text-sm text-(--color-error)">{formErrors.relationship}</p>
              )}
            </div>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input 
              ...
              aria-describedby={formErrors.birthDate ? getErrorId('birthDate') : undefined} 
              className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) ${
                formErrors.birthDate ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
              }`} 
              disabled={isSubmitting} 
            />
            <div className="mt-1 min-h-[20px]" aria-live="polite">
              {formErrors.birthDate && (
                <p id={getErrorId('birthDate')} role="alert" className="text-sm text-(--color-error)">{formErrors.birthDate}</p>
              )}
            </div>
          </div>
          <div>
            ...
            <input 
              ...
              onChange={handleInputChange} 
              aria-invalid={!!formErrors.deathDate} 
              aria-describedby={formErrors.deathDate ? getErrorId('deathDate') : undefined} 
              className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) ${
                formErrors.deathDate ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
              }`} 
              disabled={isSubmitting} 
            />
            <div className="mt-1 min-h-[20px]" aria-live="polite">
              {formErrors.deathDate && (
                <p id={getErrorId('deathDate')} role="alert" className="text-sm text-(--color-error)">{formErrors.deathDate}</p>
              )}
            </div>
          </div>
        </div>
      ...
      <section aria-labelledby="section-photo" className="border-t border-(--color-neutral-100) pt-4 u-section-reveal">
        ...
        <div className="mt-1 min-h-[20px]" aria-live="polite">
          {formErrors.photo && (
            <p id={getErrorId('photo')} role="alert" className="text-sm text-(--color-error)">{formErrors.photo}</p>
          )}
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input 
              ...
              aria-describedby={formErrors.email ? getErrorId('email') : undefined} 
              className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) ${
                formErrors.email ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
              }`} 
            ...
            <div className="mt-1 min-h-[20px]" aria-live="polite">
              {formErrors.email && (
                <p id={getErrorId('email')} role="alert" className="text-sm text-(--color-error)">{formErrors.email}</p>
              )}
            </div>
          </div>
          <div>
            ...
            <input 
              ...
              aria-describedby={formErrors.phone ? getErrorId('phone') : undefined} 
              className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) ${
                formErrors.phone ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
              }`} 
            ...
            <div className="mt-1 min-h-[20px]" aria-live="polite">
              {formErrors.phone && (
                <p id={getErrorId('phone')} role="alert" className="text-sm text-(--color-error)">{formErrors.phone}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select 
              ...
              aria-describedby={formErrors.parentId ? getErrorId('parentId') : undefined} 
              className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) ${
                formErrors.parentId ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
              }`} 
              disabled={isSubmitting}
            >
            ...
            <div className="mt-1 min-h-[20px]" aria-live="polite">
              {formErrors.parentId && (
                <p id={getErrorId('parentId')} role="alert" className="text-sm text-(--color-error)">{formErrors.parentId}</p>
              )}
            </div>
          </div>
          <div>
            ...
            <select 
              ...
              aria-invalid={!!formErrors.spouseIds} 
              aria-describedby={formErrors.spouseIds ? getErrorId('spouseIds') : undefined} 
              className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) ${
                formErrors.spouseIds ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
              }`} 
              disabled={isSubmitting} 
              size={3}
            >
            ...
            <div className="mt-1 min-h-[20px]" aria-live="polite">
              {formErrors.spouseIds && (
                <p id={getErrorId('spouseIds')} role="alert" className="text-sm text-(--color-error)">{formErrors.spouseIds}</p>
              )}
            </div>
          </div>
        </div>
      ...
      <section aria-labelledby="section-biography" className="border-t border-(--color-neutral-100) pt-4 u-section-reveal">
        ...
        <label htmlFor="biography" className="block text-sm font-medium text-(--color-neutral-700) mb-1">
          Biography <span className="text-sm text-(--color-neutral-500) ml-2">({formData.biography.length}/1000 characters)</span>
        </label>
        <textarea 
          id="biography" 
          name="biography" 
          ...
          onChange={handleInputChange} 
          rows={3} 
          aria-invalid={!!formErrors.biography} 
          aria-describedby={formErrors.biography ? getErrorId('biography') : undefined} 
          className={`w-full px-3 py-2 border rounded-[var(--radius-md)] shadow-sm focus:outline-none focus:ring-2 focus:ring-(--color-primary) focus:border-(--color-primary) resize-vertical ${
            formErrors.biography ? 'border-(--color-error)/40' : 'border-(--color-neutral-200)'
          }`} 
        ...
        <div className="mt-1 min-h-[20px]" aria-live="polite">
          {formErrors.biography && (
            <p id={getErrorId('biography')} role="alert" className="text-sm text-(--color-error)">{formErrors.biography}</p>
          )}
        </div>
      </section>
      ...
      <div className="flex justify-end space-x-3 pt-6 border-t border-(--color-neutral-100)">
        <button 
          type="button" 
          onClick={onCancel} 
          className="px-4 py-2 btn-outline text-sm font-medium text-(--color-neutral-700) max-sm:min-h-[44px]" 
          disabled={isSubmitting}
        >
          Cancel
        </button>
        <button 
          type="submit" 
          className="px-4 py-2 btn-primary btn-primary--gradient focus-visible:outline-2 focus-visible:outline-(--color-primary) focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed max-sm:min-h-[44px] motion-reduce:transition-none" 
          disabled={isSubmitting}
        >
